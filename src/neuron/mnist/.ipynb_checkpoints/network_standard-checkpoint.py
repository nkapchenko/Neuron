...
class Network:
    ...
    def __init__(self, sizes, activation_function=sigmoid, activation_function_derivative=sigmoid_prime):
        ...
        #debug
        self.debug_djdw_by_batch = []
        self.debug_djdb_by_batch = []
        self.debug_deltas_by_batch = []
        self.debug_acts_by_batch = []
        self.debug_correct_answ = []
    ...
    def SGD(self, X, y, epochs, batch_size=1, learning_rate=1, eps=1e-6):
        """
...
#             np.random.shuffle(Xy)
    ...
    def backpropa(self, X, answers):
        ...
        self.debug_acts_by_batch.append(activations)
        ...
        self.debug_djdw_by_batch.append(dJdw)
        self.debug_djdb_by_batch.append(dJdb)
        self.debug_deltas_by_batch.append(deltas)
